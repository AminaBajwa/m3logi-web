        ...
        <div class="header-top">
            <div class="top-left">
                ...
                <ul class="list-style-one">
                    <li><i class="fa fa-map-marker-alt"></i>Aks Hatchobori Bldg 5 Floor, 2 Chome 27-6,
Hatchobori, Chuo-ku, Tokyo-to Japan 104-0032</li>
                ...
                <ul class="contact-list-one">
                    <li>
                        ...
                        <div class="contact-info-box">
                            ...
                            <NuxtLink to="/tel:+92880098670">+81-3-6262-8600</NuxtLink>
                        </div>
                    </li>
                    <li>
                        <!-- Contact Info Box -->
