...
import { _ as _imports_0 } from './bg1-9FCO0GRH.mjs';
import { _ as _imports_1 } from './testi-thumb-1-Rphc5K-G.mjs';
import { _ as _imports_2, b as _imports_3, a as _imports_4, c as _imports_5 } from './news-3-HJPyztZQ.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div></div><div class="comment-one"><h3 class="comment-one__title">2 Comments</h3><div class="comment-one__single"><div class="comment-one__image"><img${ssrRenderAttr("src", _imports_1)} alt=""></div><div class="comment-one__content"><h3>Kevin Martin</h3><p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla. Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla, sollicitudin at euismod. </p>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/news-details",
  ...
  _push(`</div></div><div class="comment-one__single"><div class="comment-one__image"><img${ssrRenderAttr("src", _imports_2)} alt=""></div><div class="comment-one__content"><h3>Sarah Albert</h3><p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla. Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla, sollicitudin at euismod. </p>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/news-details",
    class: "theme-btn btn-style-one comment-one__btn"
  }, {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/news-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Logistics<span class="icon-right-arrow"${_scopeId}></span>`);
      } else {
        return [
          createTextVNode("Logistics"),
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/news-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Cargo<span class="icon-right-arrow"${_scopeId}></span>`);
      } else {
        return [
          createTextVNode("Cargo"),
          createVNode("span", { class: "icon-right-arrow" })
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/news-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Delivery<span class="icon-right-arrow"${_scopeId}></span>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/news-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Transport<span class="icon-right-arrow"${_scopeId}></span>`);
      } else {
        return [
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/news-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`Warehouses<span class="icon-right-arrow"${_scopeId}></span>`);
      } else {
        return [
...
_sfc_main$1.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("components/sections/News/Details.vue");
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs) {
  ...
  const _component_SectionsNewsDetails = __nuxt_component_1;
  _push(`<!--[-->`);
  _push(ssrRenderComponent(_component_LayoutPageTitle, { title: "Contact Us" }, null, _parent));
  _push(ssrRenderComponent(_component_SectionsNewsDetails, null, null, _parent));
  _push(`<!--]-->`);
}
...
const newsDetails = /* @__PURE__ */ _export_sfc(_sfc_main, [["ssrRender", _sfc_ssrRender]]);

export { newsDetails as default };
//# sourceMappingURL=news-details-RbnGq3yl.mjs.map
