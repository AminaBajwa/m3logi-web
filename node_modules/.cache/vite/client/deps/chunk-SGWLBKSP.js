...
function quickselect(array3, k2, left = 0, right = Infinity, compare) {
  ...
  while (right > left) {
    ...
    if (compare(array3[left], t) === 0)
      swap(array3, left, j);
    else
      ++j, swap(array3, j, right);
    if (j <= k2)
      left = j + 1;
    if (k2 <= j)
      right = j - 1;
...
function thresholdFreedmanDiaconis(values, min3, max3) {
  ...
  return c3 && d ? Math.ceil((max3 - min3) / (2 * d * Math.pow(c3, -1 / 3))) : 1;
}

// node_modules/d3-array/src/threshold/scott.js
function thresholdScott(values, min3, max3) {
  const c3 = count(values), d = deviation(values);
  return c3 && d ? Math.ceil((max3 - min3) * Math.cbrt(c3) / (3.49 * d)) : 1;
}
...
function rank(values, valueof = ascending2) {
  ...
  if (valueof.length !== 2)
    V = V.map(valueof), valueof = ascending2;
...
function encloseBasis3(a3, b, c3) {
  var x1 = a3.x, y1 = a3.y, r1 = a3.r, x2 = b.x, y2 = b.y, r2 = b.r, x3 = c3.x, y3 = c3.y, r3 = c3.r, a22 = x1 - x2, a32 = x1 - x3, b22 = y1 - y2, b32 = y1 - y3, c22 = r2 - r1, c32 = r3 - r1, d1 = x1 * x1 + y1 * y1 - r1 * r1, d2 = d1 - x2 * x2 - y2 * y2 + r2 * r2, d3 = d1 - x3 * x3 - y3 * y3 + r3 * r3, ab = a32 * b22 - a22 * b32, xa = (b22 * d3 - b32 * d2) / (ab * 2) - x1, xb = (b32 * c22 - b22 * c32) / ab, ya = (a32 * d2 - a22 * d3) / (ab * 2) - y1, yb = (a22 * c32 - a32 * c22) / ab, A2 = xb * xb + yb * yb - 1, B2 = 2 * (r1 + xa * xb + ya * yb), C2 = xa * xa + ya * ya - r1 * r1, r = -(Math.abs(A2) > 1e-6 ? (B2 + Math.sqrt(B2 * B2 - 4 * A2 * C2)) / (2 * A2) : C2 / B2);
  return {
    x: x1 + xa + xb * r,
    y: y1 + ya + yb * r,
    r
...
function packSiblingsRandom(circles, random) {
  if (!(n = (circles = array_default(circles)).length))
    return 0;
  var a3, b, c3, n, aa, ca, i, j, k2, sj, sk;
...
var amplitude = 1;
var period = 0.3;
var elasticIn = function custom9(a3, p) {
...
function zoom_default2() {
  ...
  zoom.scaleTo = function(selection2, k2, p, event) {
    zoom.transform(selection2, function() {
      var e = extent2.apply(this, arguments), t02 = this.__zoom, p0 = p == null ? centroid(e) : typeof p === "function" ? p.apply(this, arguments) : p, p1 = t02.invert(p0), k1 = typeof k2 === "function" ? k2.apply(this, arguments) : k2;
...
function arc_default() {
  ...
  function arc() {
    ...
    if (!(r1 > epsilon3))
      ...
      var a01 = a0, a11 = a1, a00 = a0, a10 = a1, da0 = da, da1 = da, ap = padAngle.apply(this, arguments) / 2, rp = ap > epsilon3 && (padRadius ? +padRadius.apply(this, arguments) : sqrt(r0 * r0 + r1 * r1)), rc = min2(abs(r1 - r0) / 2, +cornerRadius.apply(this, arguments)), rc0 = rc, rc1 = rc, t02, t12;
      if (rp > epsilon3) {
...
function area_default(x0, y0, y1) {
  var x1 = null, defined = constant_default6(true), context = null, curve = linear_default, output = null, path2 = withPath(area);
...
function pie_default() {
  var value = identity_default, sortValues = descending_default, sort2 = null, startAngle = constant_default6(0), endAngle = constant_default6(tau3), padAngle = constant_default6(0);
  function pie(data) {
...
var star_default = {
  draw(context, size) {
    ...
    for (let i = 1; i < 5; ++i) {
      ...
      context.lineTo(c3 * x2 - s2 * y2, s2 * x2 + c3 * y2);
    }
    context.closePath();
  }
};
...
var wye_default = {
  draw(context, size) {
    ...
    context.lineTo(c2 * x2 - s * y2, s * x2 + c2 * y2);
    context.lineTo(c2 * x0 + s * y0, c2 * y0 - s * x0);
    context.lineTo(c2 * x1 + s * y1, c2 * y1 - s * x1);
    context.lineTo(c2 * x2 + s * y2, c2 * y2 - s * x2);
    context.closePath();
  }
};
...
function Symbol2(type, size) {
  ...
  type = typeof type === "function" ? type : constant_default6(type || circle_default);
...
export {
  ...
  discrete_default,
  hue_default,
  round_default2 as round_default,
...
//# sourceMappingURL=chunk-SGWLBKSP.js.map
