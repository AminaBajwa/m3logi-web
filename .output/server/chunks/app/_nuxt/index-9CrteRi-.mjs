...
import { _ as _imports_0$2$1, b as _imports_0$6, a as _imports_0$1$2 } from './delivery-boy-aO9Du3cD.mjs';
import { _ as _export_sfc } from '../server.mjs';
import { _ as _imports_0$1$1, b as _imports_1$1, a as _imports_2$1, c as _imports_0$8, d as _imports_1$6, e as _imports_2$5, f as _imports_3$3, g as _imports_4$1, h as _imports_5$1, i as _imports_6, j as _imports_7, k as _imports_8, l as _imports_9, m as _imports_10, n as _imports_11 } from './client-img12-Z7sEQmcV.mjs';
import { _ as _imports_3, a as _imports_1$2, b as _imports_0$4, c as _imports_2 } from './service-4-4xo4pTju.mjs';
import { M as ModalVideo, _ as _imports_2$4 } from './testi-thumb-3-oFbyzsYG.mjs';
import { _ as _imports_0$5, a as _imports_1$3, b as _imports_2$2, c as _imports_3$1 } from './project-4-9sH5mCY_.mjs';
import { _ as _imports_0$7 } from './about-3-kCTB2HPF.mjs';
import { _ as _imports_1$4 } from './about-4-fQZE_5GS.mjs';
import { _ as _imports_1$5 } from './testi-thumb-1-Rphc5K-G.mjs';
import { _ as _imports_2$3, a as _imports_4, b as _imports_3$2, c as _imports_5 } from './news-3-HJPyztZQ.mjs';
        ...
        _push2(ssrRenderComponent(_component_swiper_slide, { class: "slide-item" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(`</div></div><figure class="image animate-5 animate-x"${_scopeId2}><img${ssrRenderAttr("src", _imports_0$2$1)} alt=""${_scopeId2}></figure></div></div></div></div>`);
            } else {
              return [
                createVNode("div", {
                  class: "bg-image",
...
function _sfc_ssrRender$e(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div></div></div><div class="image-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column"><figure class="image-1"><img${ssrRenderAttr("src", _imports_1$1)} alt=""></figure><figure class="image-2"><img${ssrRenderAttr("src", _imports_2$1)} alt=""></figure><div class="experience"><strong><i class="icon flaticon-global"></i> 12+<br> Years</strong> Working Exprience</div></div></div></div></div></section>`);
}
...
const _imports_0$3 = "" + publicAssetsURL("images/icons/arrow-2.png");
const _sfc_main$c = {};
...
const _imports_0$2 = "" + publicAssetsURL("images/resource/image-1.png");
const _sfc_main$9 = {};
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "about-section-two" }, _attrs))}><div class="auto-container"><div class="row"><div class="content-column col-lg-6 col-md-12 col-sm-12 order-2"><div class="inner-column"><div class="sec-title"><span class="sub-title">Get to know us</span><h2>Global Logistics Solution Provider 2012</h2><h4>Simplify your freight and logistics needs with a personal approch.</h4><div class="text">Explain to you how all this mistaken denouncing pleasure and praising pain was born and we will give you a complete account of the system, and expound the actual teachings.</div></div><div class="row"><div class="feature-block-three col-lg-4 col-md-4 col-sm-12"><div class="inner"><i class="icon flaticon-delivery-courier"></i><h4 class="title">Cost Optimisation</h4></div></div><div class="feature-block-three col-lg-4 col-md-4 col-sm-12"><div class="inner"><i class="icon flaticon-delivery-insurance-3"></i><h4 class="title">Reduced <br>Transit Time</h4></div></div><div class="feature-block-three col-lg-4 col-md-4 col-sm-12"><div class="inner"><i class="icon flaticon-delivery-box-3"></i><h4 class="title">Delivery <br>on Time</h4></div></div></div><div class="founder-info"><div class="thumb"><img${ssrRenderAttr("src", _imports_0$1$2)} alt=""></div><h5 class="name">Muzammal Majeed</h5><span class="designation">CEO &amp; Founder of Company</span></div></div></div><div class="image-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column"><figure class="image-1 wow fadeInUp"><img${ssrRenderAttr("src", _imports_0$7)} alt=""></figure><figure class="image-2 wow fadeInRight"><img${ssrRenderAttr("src", _imports_1$4)} alt=""><div class="icon-box"><i class="icon flaticon-delivery-box-4"></i></div></figure></div></div></div></div></section>`);
}
...
const _imports_0$1 = "" + publicAssetsURL("images/resource/offer-img-1.jpg");
const _imports_1 = "" + publicAssetsURL("images/resource/offer-img-2.jpg");
const _sfc_main$4 = {};
...
const _imports_0 = "" + publicAssetsURL("images/resource/float-img-2.png");
const _sfc_main$3 = {};
...
//# sourceMappingURL=index-9CrteRi-.mjs.map
