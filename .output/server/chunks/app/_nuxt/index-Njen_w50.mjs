...
import { _ as _imports_0$1$2, a as _imports_2$1$1, b as _imports_1$1$1, c as _imports_0$5, d as _imports_1$4, e as _imports_2$4, f as _imports_3$3, g as _imports_4$3, h as _imports_5$2, i as _imports_6$1, j as _imports_7$1, k as _imports_8, l as _imports_9, m as _imports_10, n as _imports_11 } from './client-img12-Z7sEQmcV.mjs';
import { _ as _imports_0$1$3, a as _imports_1$2, b as _imports_2$2, c as _imports_3$2, d as _imports_4$2, e as _imports_5$1, f as _imports_6, g as _imports_7, h as _imports_0$3 } from './m3logiOffice-StZRbHgU.mjs';
import { _ as _imports_0$4, a as _imports_1$3, b as _imports_2$3 } from './arrow-3-CQ_A2Kl6.mjs';
...
const _imports_0$1 = "" + publicAssetsURL("images/main-slider/slider1.png");
const _imports_1$1 = "" + publicAssetsURL("images/truck -m3.png");
const _imports_3$1 = "" + publicAssetsURL("images/main-slider/slider2.png");
const _imports_4$1 = "" + publicAssetsURL("images/main-slider/slider3.png");
const _sfc_main$a = {
  components: {
    Swiper,
    SwiperSlide
        ...
        _push2(ssrRenderComponent(_component_swiper_slide, { class: "slide-item" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              ...
              _push3(`</div></div></div><div class="image-column col-lg-5 col-md-12 col-sm-12"${_scopeId2}><div class="image-box"${_scopeId2}><div class="fact-counter-one bounce-y"${_scopeId2}><h4 class="counter-title"${_scopeId2}>Global <br${_scopeId2}> Network</h4></div><figure class="image animate-5 animate-x"${_scopeId2}><img${ssrRenderAttr("src", _imports_0$1$1)} alt=""${_scopeId2}></figure></div></div></div></div>`);
            } else {
              return [
                createVNode("div", {
                  class: "bg-image",
...
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div></div></div><div class="image-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column" id="img"><figure class="image-1"><img${ssrRenderAttr("src", _imports_2$1$1)} alt=""></figure><figure class="image-2"><img${ssrRenderAttr("src", _imports_1$1$1)} alt=""></figure><div class="experience"><strong><i class="icon flaticon-global"></i> 12+<br> Years</strong> Working Exprience</div></div></div></div></div></section>`);
}
...
function _sfc_ssrRender$7(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/page-service-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0$1$3)} alt=""${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0$1$3,
...
const _imports_2$1 = "" + publicAssetsURL("images/gallery-3.jpg");
const _sfc_main$5 = {};
function _sfc_ssrRender$5(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "about-section-two" }, _attrs))}><div class="auto-container"><div class="row"><div class="content-column col-lg-6 col-md-12 col-sm-12 order-2"><div class="inner-column"><div class="sec-title"><span class="sub-title">Get to know us</span><h2>Global Logistics Solution Provider</h2><h4>Simplify your freight and logistics needs with a personal approch.</h4><h3>Message from CEO</h3><blockquote class="ceo-quote"> We support our customers in all aspects of their cargo from storage, transportation, and delivery, and strive for their benefit. If you are considering importing or exporting, please contact us and we will be happy to assist you. </blockquote><cite class="ceo-cite">\u2014 Muzammal Majeed, CEO &amp; Founder</cite></div><div class="founder-info"><div class="thumb"><img${ssrRenderAttr("src", _imports_0$2)} alt=""></div><h5 class="name">Muzammal Majeed</h5><span class="designation">CEO &amp; Founder of Company</span></div></div></div><div class="image-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column"><figure class="image-1 wow fadeInUp"><img${ssrRenderAttr("src", _imports_0$3)} alt=""></figure><figure class="image-2 wow fadeInRight"><img${ssrRenderAttr("src", _imports_2$1)} alt=""></figure></div></div></div></div></section>`);
}
...
function _sfc_ssrRender$4(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><section class="why-choose-us-two"><div class="bg-image" style="${ssrRenderStyle({ "background-image": "url(./images/background/6.jpg)" })}"></div><div class="bg-shape"><div class="shape" style="${ssrRenderStyle({ "background-image": "url(./images/icons/bg-shape1.png)" })}"></div></div><div class="anim-icons"><div class="float-image wow zoomInLeft"><img${ssrRenderAttr("src", _imports_0$4)} alt=""></div></div><div class="auto-container"><div class="row"><div class="content-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column wow fadeInLeft"><div class="sec-title light"><span class="sub-title">Why Choose Us</span><h2>Simple Online Booking, Full Carrier Responsibility.</h2><div class="text">We provide trusted, end-to-end logistics solutions with reliable shipping, strong global coverage, and unmatched expertise in vehicle handling and transportation</div></div><div class="row"><div class="feature-block-four col-lg-6 col-md-6 col-sm-12"><div class="inner-box"><i class="icon flaticon-delivery-box-4"></i><h4 class="title">Total Logistics<br>Solutions</h4><p class="text">End-to-end shipping made simple and seamless.</p></div></div><div class="feature-block-four col-lg-6 col-md-6 col-sm-12"><div class="inner-box"><i class="icon flaticon-international-shipping-3"></i><h4 class="title">Shipping <br>Worldwide</h4><p class="text">Global coverage with flexible and trusted schedules.</p></div></div></div></div></div><div class="image-column col-lg-6 col-md-12 col-sm-12"><div class="image-box hide-desktop"><img${ssrRenderAttr("src", _imports_1$3)} alt=""></div><div class="inner-column"><div class="info-box bounce-y"><i class="icon flaticon-customer-service"></i><strong>Global Coverage,<br> Trusted Schedules</strong></div><div class="video-box">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
  ...
  _push(`<img${ssrRenderAttr("src", _imports_2$3)} alt="" class="arrow"></div></div></div></div></div></section>`);
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_NuxtLink, {
                ...
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<img class="client-logo"${ssrRenderAttr("src", _imports_0$5)} alt=""${_scopeId3}>`);
                  } else {
                    return [
                      createVNode("img", {
                        class: "client-logo",
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_NuxtLink, { to: "#" }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<img${ssrRenderAttr("src", _imports_2$4)} alt=""${_scopeId3}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: _imports_2$4,
...
//# sourceMappingURL=index-Njen_w50.mjs.map
