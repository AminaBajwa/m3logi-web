...
import { _ as _imports_0$1 } from './testi-thumb-1-GDJFDpmc.mjs';
import { _ as _imports_1 } from './testi-thumb-2-GFqmT0Cf.mjs';
import { a as _imports_1$1, _ as _imports_0$2, b as _imports_2 } from './news-3-Q4CK2Ms6.mjs';
...
function _sfc_ssrRender$1(_ctx, _push, _parent, _attrs) {
  ...
  _push(`</div></div><div class="comment-one"><h3 class="comment-one__title">2 Comments</h3><div class="comment-one__single"><div class="comment-one__image"><img${ssrRenderAttr("src", _imports_0$1)} alt=""></div><div class="comment-one__content"><h3>Kevin Martin</h3><p>Mauris non dignissim purus, ac commodo diam. Donec sit amet lacinia nulla. Aliquam quis purus in justo pulvinar tempor. Aliquam tellus nulla, sollicitudin at euismod. </p>`);
  _push(ssrRenderComponent(_component_NuxtLink, {
    to: "/news-details",
  ...
  _push(`</h3></div></li><li><div class="sidebar__post-image"><img${ssrRenderAttr("src", _imports_0$2)} alt=""></div><div class="sidebar__post-content"><h3><span class="sidebar__post-content-meta"><i class="fas fa-user-circle"></i>Admin</span> `);
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/news-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
...
//# sourceMappingURL=news-details-1eGoqqGe.mjs.map
