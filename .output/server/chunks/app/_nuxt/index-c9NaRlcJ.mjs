...
import { M as ModalVideo, _ as _imports_0$2$1, a as _imports_0$1$1, b as _imports_0$6 } from './delivery-boy-z3bljpix.mjs';
import { _ as _export_sfc } from '../server.mjs';
import { _ as _imports_0$3, a as _imports_1$3 } from './about-4-7KiI2d46.mjs';
import { _ as _imports_0$4, a as _imports_1$4, b as _imports_2$2, c as _imports_3 } from './project-4-9sH5mCY_.mjs';
import { _ as _imports_0$5, a as _imports_1$5, b as _imports_2$3 } from './team-3-iV7YWsR1.mjs';
import { _ as _imports_2$4 } from './testi-thumb-3-6l17gWPZ.mjs';
import { _ as _imports_1$6 } from './testi-thumb-2-GFqmT0Cf.mjs';
import { _ as _imports_0$7, a as _imports_1$7, b as _imports_2$5 } from './news-3-Q4CK2Ms6.mjs';
...
const _imports_0$2 = "" + publicAssetsURL("images/resource/float-img-4.png");
const _sfc_main$e = {};
function _sfc_ssrRender$e(_ctx, _push, _parent, _attrs) {
  ...
  _push(`%</div></div></div></div></div></div></div><div class="founder-info"><div class="thumb"><img${ssrRenderAttr("src", _imports_0$1$1)} alt=""></div><h5 class="name">Muzammal Majeed</h5><span class="designation">CEO &amp; Founder of Company</span></div></div></div><div class="image-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column"><figure class="image-1"><img${ssrRenderAttr("src", _imports_0$3)} alt=""></figure><figure class="image-2"><img${ssrRenderAttr("src", _imports_1$3)} alt=""><div class="icon-box"><i class="icon flaticon-delivery-box-4"></i></div></figure></div></div></div></div></section>`);
}
...
const _imports_0$1 = "" + publicAssetsURL("images/resource/service-5.jpg");
const _imports_1$2 = "" + publicAssetsURL("images/resource/service-6.jpg");
const _imports_2$1 = "" + publicAssetsURL("images/resource/service-7.jpg");
const _sfc_main$d = {
  components: {
    Swiper,
    SwiperSlide
...
const _imports_0 = "" + publicAssetsURL("images/resource/float-img-3.png");
const _imports_1$1 = "" + publicAssetsURL("images/background/6.jpg");
const _imports_2 = "" + publicAssetsURL("images/icons/arrow-3.png");
const _sfc_main$a = {
  components: {
    ModalVideo
  },
...
function _sfc_ssrRender$9(_ctx, _push, _parent, _attrs) {
  ...
  _push(ssrRenderComponent(_component_NuxtLink, { to: "/page-team-details" }, {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<img${ssrRenderAttr("src", _imports_0$5)} alt=""${_scopeId}>`);
      } else {
        return [
          createVNode("img", {
            src: _imports_0$5,
...
function _sfc_ssrRender$8(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  const _component_swiper = resolveComponent("swiper");
  const _component_swiper_slide = resolveComponent("swiper-slide");
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "testimonial-section-two" }, _attrs))}><div class="bg-image" style="${ssrRenderStyle({ "background-image": "url(./images/background/7.jpg)" })}"></div><div class="anim-icons"><span class="icon icon-plane-1 bounce-y"></span><div class="icon float-image wow fadeInRight"><img${ssrRenderAttr("src", _imports_0$6)} alt=""></div></div><div class="auto-container"><div class="row"><div class="testimonial-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column"><div class="sec-title"><span class="sub-title">Our Testimonial</span><h2>What they\u2019re talking <br>about company</h2></div>`);
  _push(ssrRenderComponent(_component_swiper, {
    "slides-per-view": 1,
    "space-between": 30,
    loop: true,
...
//# sourceMappingURL=index-c9NaRlcJ.mjs.map
