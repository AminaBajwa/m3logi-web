...
export default {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.pIRZzZqi.mjs').then(interopDefault),
  "pages/page-about.vue": () => import('./_nuxt/page-about-styles.l6nA6InJ.mjs').then(interopDefault),
