...
function area_default(x0, y0, y1) {
  var x1 = null, defined = constant_default5(true), context = null, curve = linear_default, output = null, path2 = withPath(area);
...
function pie_default() {
  var value = identity_default, sortValues = descending_default, sort2 = null, startAngle = constant_default5(0), endAngle = constant_default5(tau3), padAngle = constant_default5(0);
  function pie(data) {
...
function Symbol2(type, size) {
  ...
  type = typeof type === "function" ? type : constant_default5(type || circle_default);
...
//# sourceMappingURL=chunk-KP4K2OUN.js.map
