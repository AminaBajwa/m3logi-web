  ...
  <section class="loc-sects1">
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 nopad-right cntc">
          <div class="loc-images img-trans">
            <img src="/assets/images/durban-of.png" alt="Durban Office">
          </div>
        </div>
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 nopad-right cntc">
          <div class="loc-images img-trans">
            <img src="/assets/images/chile-of.png" alt="Chile Office">
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 cntc">
      ...
      <div class="row">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 nopad-right cntc">
          <div class="loc-images img-trans">
            <img src="/assets/images/mozambique-of.jpg" alt="Mozambique Office">
          </div>
        </div>
        <div class="col-lg-3 col-md-6 col-sm-6 cntc">
        ...
        <div class="col-lg-3 col-md-6 col-sm-6 nopad-right cntc pad-mmb">
          <div class="loc-images img-trans">
            <img src="/assets/images/pakistan-of.png" alt="Pakistan Office">
          </div>
        </div>
...
<style scoped>
/* Add any necessary styles here, assuming the original CSS classes are available */
.loc-sects1 {
