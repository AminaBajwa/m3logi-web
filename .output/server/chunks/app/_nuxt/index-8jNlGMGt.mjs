...
import { M as ModalVideo, _ as _imports_0$1$1, a as _imports_0$7 } from './ModalVideo-xrJeC4ky.mjs';
import { _ as _export_sfc } from '../server.mjs';
import { _ as _imports_0$1$2, b as _imports_1$1, a as _imports_2$1, c as _imports_0$9, d as _imports_1$6, e as _imports_2$5, f as _imports_3$3, g as _imports_4$1, h as _imports_5$1, i as _imports_6, j as _imports_7, k as _imports_8, l as _imports_9, m as _imports_10, n as _imports_11 } from './client-img12-Z7sEQmcV.mjs';
...
import { _ as _imports_0$6, a as _imports_2$4 } from './testi-thumb-3-kcWvlNwy.mjs';
import { _ as _imports_0$8, a as _imports_1$4 } from './about-4-7KiI2d46.mjs';
...
function _sfc_ssrRender$6(_ctx, _push, _parent, _attrs) {
  _push(`<section${ssrRenderAttrs(mergeProps({ class: "about-section-two" }, _attrs))}><div class="auto-container"><div class="row"><div class="content-column col-lg-6 col-md-12 col-sm-12 order-2"><div class="inner-column"><div class="sec-title"><span class="sub-title">Get to know us</span><h2>Global Logistics Solution Provider 2012</h2><h4>Simplify your freight and logistics needs with a personal approch.</h4><div class="text">Explain to you how all this mistaken denouncing pleasure and praising pain was born and we will give you a complete account of the system, and expound the actual teachings.</div></div><div class="row"><div class="feature-block-three col-lg-4 col-md-4 col-sm-12"><div class="inner"><i class="icon flaticon-delivery-courier"></i><h4 class="title">Cost Optimisation</h4></div></div><div class="feature-block-three col-lg-4 col-md-4 col-sm-12"><div class="inner"><i class="icon flaticon-delivery-insurance-3"></i><h4 class="title">Reduced <br>Transit Time</h4></div></div><div class="feature-block-three col-lg-4 col-md-4 col-sm-12"><div class="inner"><i class="icon flaticon-delivery-box-3"></i><h4 class="title">Delivery <br>on Time</h4></div></div></div><div class="founder-info"><div class="thumb"><img${ssrRenderAttr("src", _imports_0$7)} alt=""></div><h5 class="name">Muzammal Majeed</h5><span class="designation">CEO &amp; Founder of Company</span></div></div></div><div class="image-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column"><figure class="image-1 wow fadeInUp"><img${ssrRenderAttr("src", _imports_0$8)} alt=""></figure><figure class="image-2 wow fadeInRight"><img${ssrRenderAttr("src", _imports_1$4)} alt=""><div class="icon-box"><i class="icon flaticon-delivery-box-4"></i></div></figure></div></div></div></div></section>`);
}
          ...
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(_component_NuxtLink, { to: "#" }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<img${ssrRenderAttr("src", _imports_0$9)} alt=""${_scopeId3}>`);
                  } else {
                    return [
                      createVNode("img", {
                        src: _imports_0$9,
...
//# sourceMappingURL=index-8jNlGMGt.mjs.map
