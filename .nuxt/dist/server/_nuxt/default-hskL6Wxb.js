...
import { _ as __nuxt_component_1$1, a as __nuxt_component_2, b as __nuxt_component_2$1 } from "./BackToTop--Y9_Bxat.js";
...
import "klona";
import "devalue";
const _imports_0 = "" + __publicAssetsURL("images/logoM3Logi-.png");
const _sfc_main$2 = {
  __name: "Header1",
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="header-top"><div class="top-left"><ul class="list-style-one"><li><i class="fa fa-map-marker-alt"></i> AKS Hatchobori Bldg 5floor</li><li><i class="fa fa-clock"></i> Mon - Sat: 8am - 5pm</li><li><i class="fa fa-phone-volume"></i>`);
...
const _imports_1 = "" + __publicAssetsURL("images/resource/project-thumb-1.jpg");
const _imports_2 = "" + __publicAssetsURL("images/resource/project-thumb-2.jpg");
const _imports_3 = "" + __publicAssetsURL("images/resource/project-thumb-3.jpg");
const _imports_4 = "" + __publicAssetsURL("images/resource/project-thumb-4.jpg");
const _imports_5 = "" + __publicAssetsURL("images/resource/project-thumb-5.jpg");
const _imports_6 = "" + __publicAssetsURL("images/resource/project-thumb-6.jpg");
const _sfc_main$1 = {};
...
//# sourceMappingURL=default-hskL6Wxb.js.map
