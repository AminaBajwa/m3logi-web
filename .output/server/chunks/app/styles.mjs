...
const styles = {
  "node_modules/nuxt/dist/app/entry.js": () => import('./_nuxt/entry-styles.owLvHgHw.mjs').then(interopDefault),
  "pages/page-about.vue": () => import('./_nuxt/page-about-styles.SGHXQfVz.mjs').then(interopDefault),
