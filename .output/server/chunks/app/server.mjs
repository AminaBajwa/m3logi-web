...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-gYuk51OD.mjs').then((m) => m.default || m)
  },
  {
    name: "index-3",
    path: "/index-3",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-Njen_w50.mjs').then((m) => m.default || m)
  },
  {
    name: "index",
    path: "/",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8jNlGMGt.mjs').then((m) => m.default || m)
  },
  {
    name: "news-details",
    path: "/news-details",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-about-g7C1FED0.mjs').then((m) => m.default || m)
  },
  {
    name: "page-contact",
    path: "/page-contact",
  ...
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-project-details-4lU5pQ0M.mjs').then((m) => m.default || m)
  },
  {
    name: "page-projects",
    path: "/page-projects",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-projects-gMjUhkep.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-service-details-ExQtnEpF.mjs').then((m) => m.default || m)
  },
  {
    name: "page-services",
    path: "/page-services",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-services-_dSEZSvM.mjs').then((m) => m.default || m)
  },
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-team-details-nosCcxAO.mjs').then((m) => m.default || m)
  },
  {
    name: "page-team",
    path: "/page-team",
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/page-team-2CbK2GqS.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: () => import('./_nuxt/default-ID5wWu4-.mjs').then((m) => m.default || m),
  layout2: () => import('./_nuxt/layout2-Wztn3ECj.mjs').then((m) => m.default || m)
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./_nuxt/error-404-KEv0fSvv.mjs').then((r) => r.default || r));
