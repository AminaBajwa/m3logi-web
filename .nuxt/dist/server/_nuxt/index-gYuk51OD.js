...
import { _ as _imports_0$2, a as _imports_0$3, M as ModalVideo } from "./ModalVideo-xrJeC4ky.js";
import { _ as _export_sfc } from "../server.mjs";
import { _ as _imports_0$4, a as _imports_1$2 } from "./about-4-7KiI2d46.js";
import { _ as _imports_0$5, a as _imports_1$3, b as _imports_2$1, c as _imports_3 } from "./project-4-9sH5mCY_.js";
import { _ as _imports_0$6, a as _imports_1$4, b as _imports_2$2 } from "./arrow-3-CQ_A2Kl6.js";
...
const _imports_0$1 = "" + __publicAssetsURL("images/resource/float-img-4.png");
const _sfc_main$e = {};
function _sfc_ssrRender$e(_ctx, _push, _parent, _attrs) {
  ...
  _push(`%</div></div></div></div></div></div></div><div class="founder-info"><div class="thumb"><img${ssrRenderAttr("src", _imports_0$3)} alt=""></div><h5 class="name">Muzammal Majeed</h5><span class="designation">CEO &amp; Founder of Company</span></div></div></div><div class="image-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column"><figure class="image-1"><img${ssrRenderAttr("src", _imports_0$4)} alt=""></figure><figure class="image-2"><img${ssrRenderAttr("src", _imports_1$2)} alt=""><div class="icon-box"><i class="icon flaticon-delivery-box-4"></i></div></figure></div></div></div></div></section>`);
}
...
const _imports_0 = "" + __publicAssetsURL("images/resource/service-5.jpg");
const _imports_1$1 = "" + __publicAssetsURL("images/resource/service-6.jpg");
const _imports_2 = "" + __publicAssetsURL("images/resource/service-7.jpg");
const _sfc_main$d = {
  components: {
    Swiper,
    SwiperSlide
...
function _sfc_ssrRender$a(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(`<!--[--><section class="why-choose-us-two"><div class="bg-image" style="${ssrRenderStyle({ "background-image": "url(./images/background/6.jpg)" })}"></div><div class="bg-shape"><div class="shape" style="${ssrRenderStyle({ "background-image": "url(./images/icons/bg-shape.png)" })}"></div></div><div class="anim-icons"><div class="float-image wow zoomInLeft"><img${ssrRenderAttr("src", _imports_0$6)} alt=""></div></div><div class="auto-container"><div class="row"><div class="content-column col-lg-6 col-md-12 col-sm-12"><div class="inner-column wow fadeInLeft"><div class="sec-title light"><span class="sub-title">Why Choose Us</span><h2>We create opportunity <br>to reach potential</h2><div class="text">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.</div></div><div class="row"><div class="feature-block-four col-lg-6 col-md-6 col-sm-12"><div class="inner-box"><i class="icon flaticon-delivery-box-4"></i><h4 class="title">Safety &amp; <br>reliable service</h4><p class="text">Nullam mollis elit quis dus is lacinia not efficitur</p></div></div><div class="feature-block-four col-lg-6 col-md-6 col-sm-12"><div class="inner-box"><i class="icon flaticon-international-shipping-3"></i><h4 class="title">Real time <br>tracking system</h4><p class="text">Nullam mollis elit quis dus is lacinia not efficitur</p></div></div></div></div></div><div class="image-column col-lg-6 col-md-12 col-sm-12"><div class="image-box hide-desktop"><img${ssrRenderAttr("src", _imports_1$4)} alt=""></div><div class="inner-column"><div class="info-box bounce-y"><i class="icon flaticon-customer-service"></i><strong>Meet Our <br>Expert Agents</strong></div><div class="video-box">`);
  _push(ssrRenderComponent(_component_NuxtLink, {
...
//# sourceMappingURL=index-gYuk51OD.js.map
