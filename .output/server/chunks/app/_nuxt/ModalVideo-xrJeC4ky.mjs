...
const _imports_0$1 = "" + publicAssetsURL("images/resource/truck.png");
const _imports_0 = "" + publicAssetsURL("images/CEO.png");
const _sfc_main = {
  props: {
    videoId: String,
    channel: String,
...
export { ModalVideo as M, _imports_0$1 as _, _imports_0 as a };
//# sourceMappingURL=ModalVideo-xrJeC4ky.mjs.map
